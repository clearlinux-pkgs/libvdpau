...
Version  : 1.5
Release  : 11
URL      : https://gitlab.freedesktop.org/vdpau/libvdpau/-/archive/1.5/libvdpau-1.5.tar.gz
Source0  : https://gitlab.freedesktop.org/vdpau/libvdpau/-/archive/1.5/libvdpau-1.5.tar.gz
...
%prep
%setup -q -n libvdpau-1.5
cd %{_builddir}/libvdpau-1.5
%patch -P 1 -p1
pushd ..
cp -a libvdpau-1.5 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702025791
...
cp %{_builddir}/libvdpau-%{version}/COPYING %{buildroot}/usr/share/package-licenses/libvdpau/aedf533f647d97c8bb8f7374844d959e18cf8fe6 || :
pushd ../build32/
